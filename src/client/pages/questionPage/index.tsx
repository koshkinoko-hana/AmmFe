  ...
  return (
    <div className='body'>
      <Header
        ...
        description={'Здесь вы можете напрямую задать вопрос декану факультета ПММ проф. Медведеву Сергею Николаевичу и через некоторое время получить на него ответ. Ваш вопрос, в зависимости от сложности и загруженности декана, может рассматриваться сроком до 2х недель'}
        path={{
